...
class Settings:
    ...
    GOOGLE_VEO_MODEL: str = os.getenv("GOOGLE_VEO_MODEL", "veo-3.1-generate-001")
    ...
    MERCHANT_UPI_VPA: str = os.getenv("MERCHANT_UPI_VPA", "rupeshkumarpandey@hdfcbank")
    MERCHANT_NAME: str = os.getenv("MERCHANT_NAME", "Rupesh Kumar Pandey")
    MERCHANT_BANK_NAME: str = os.getenv("MERCHANT_BANK_NAME", "HDFC Bank")
    MERCHANT_ACCOUNT_NO: str = os.getenv("MERCHANT_ACCOUNT_NO", "50100055168323")
    MERCHANT_IFSC: str = os.getenv("MERCHANT_IFSC", "HDFC0000832")
